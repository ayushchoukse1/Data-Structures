...
public class LinkedListApp {
	...
	public static void main(String[] args) {
		...
		LinkedListNode node12 = new LinkedListNode(13);
		node12.setData(13) ;
		...
		// System.out.println("The legnth of Linked list 2 is "+
		// linkedList2.getLength());
		/*	linkedList.deleteLinkedList(4);
			linkedList.displayLinkedList();
			System.out.println("");
			System.out.println("The legnth of Linked list is "+ linkedList.getLength());*/
		// System.out.println("The position of node with data 7 is
		// "+linkedList.getPosition(7));
		...
		*/
		...
		/*
		 NthNodeLL object = new NthNodeLL();
		//object.findNthNodeFromStart(linkedList.getHead(), 3).displayNode();
		object.findNthNodeFromLastUsingTwoPointer(linkedList.getHead(), 3).displayNode();
		*/

		// MergeTwoSortedLinkedList mergeTwoSortedLinkedList = new
		// MergeTwoSortedLinkedList();
		// LinkedListNode node =
		// mergeTwoSortedLinkedList.mergeTwoSortedLinkedList(linkedList.getHead(),
		// linkedList2.getHead());
		// while (node != null) {
		// node.displayNode();
		// node = node.getNext();
		...
		ReversePairLL reversePairLL = new ReversePairLL();
		LinkedListNode node = reversePairLL.ReversePair(linkedList.getHead());
		while (node != null) {
			node.displayNode();
			node = node.getNext();
		}
